...
const PART_TYPE_OPTIONS = [
  ...
  { label: 'Intake Tube / Hose', code: 'ITH' },
  { label: 'Motor Mount', code: 'MMT' },
  { label: 'Trans Mount', code: 'TMT' },
  { label: 'TPMS Sensors', code: 'TPMS' },
  { label: 'Antenna', code: 'ANT' },
  { label: 'Turbocharger', code: 'TUR' },
  { label: 'Dash Assy', code: 'DASH' },
